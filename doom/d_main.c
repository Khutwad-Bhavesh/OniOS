...
void D_DoomLoop (void)
{
    ...
    main_loop_started = true;    printf("D_DoomLoop: Calling G_InitNew\n");
    if (demoplayback)
    ...
    printf("D_DoomLoop: Calling TryRunTics\n");
    TryRunTics();
    
    printf("D_DoomLoop: Calling I_InitGraphics\n");
    ...
    printf("D_DoomLoop: Calling V_RestoreBuffer\n");
    V_RestoreBuffer();
    R_ExecuteSetViewSize();

    printf("D_DoomLoop: Calling D_StartGameLoop\n");
    D_StartGameLoop();
    ...
    printf("D_DoomLoop: Calling doomgeneric_Tick\n");
    doomgeneric_Tick();
    printf("D_DoomLoop: Finished!\n");
}
